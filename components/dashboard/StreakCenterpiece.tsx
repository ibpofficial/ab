...
export function StreakCenterpiece({ student }: StreakCenterpieceProps) {
  ...
  return (
    <Card className="p-6 bg-white border-orange-200 streak-card-glow relative overflow-hidden space-y-4 rounded-xl text-slate-900 shadow-sm">
      ...
      <div className="p-3.5 rounded-xl bg-orange-50/60 border border-orange-100 text-xs text-slate-700 font-medium leading-relaxed">
        {isZeroStreak ? (
