...
export function UpgradeAccountModal() {
  ...
  return (
    <Card className="relative overflow-hidden p-5 bg-gradient-to-r from-orange-50 via-white to-amber-50 border border-orange-200 shadow-sm rounded-xl text-slate-900">
      <button
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-slate-600 font-medium max-w-xl">
              Sign in with Google to lock in your streak history and activate your shareable <code className="text-orange-700 font-mono">/u/yourname</code> resume link.
            </p>
          </div>
        </div>
        ...
        <div className="shrink-0">
          <Button
            ...
            onClick={handleLink}
            disabled={isLinking}
            className="text-xs py-2 px-4 shadow-xs text-slate-800 border-slate-300"
          >
